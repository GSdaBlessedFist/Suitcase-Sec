...
const comments ={
	...
	"processComments":{
		...
		"EmailUpdate": "<div class=\"info-title\">A valid email...good.</div><div class=\"info-text\">When the email input is clicked out of, the entry is checked for validity by matching it against a regex statement: </br><div class=\"info-code\"><strong><em>pattern = /^[^ ]+@[^ ]+\.[a-z]{2,3}$/<\/em></strong></div><div>If you have an account already...<span class=\"info-text-box\">Sign in<\/span><\/div><div>If you\'re a noob to the site...<span class=\"info-text-box\">New Account<\/span> or <span class=\"info-text-box\">click to activate<\/span><\/div>",
