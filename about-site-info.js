...
const aboutSiteInfo ={
	...
	"challengeDescriptions":{
		...
		"the lock UI":`<div>The default PIN is \'0000\' in case the user doesn\'t <em>activate</em> the lock component. When activated the user sees the roller elements to select a PIN. Each roller provides a value provided by it\'s own IntersectionObserver().</div><br><\/div><div class=\"lock-ui-pic\">${lockUI}<\/div>`,
